...
for lambda = [0.1, 1, 10, 100]
	for sigma = [0.001, 0.002]
		...
		figure('Name','Classification par SVM avec noyau gaussien pour lambda =' + string(lambda) + ' et sigma =' + string(sigma),'Position',[0.2*L,0.1*H,0.6*L,0.7*H]);
