...
sigmal=linspace(0.0001,0.0003,100);
sigmadete=[];
for sigma=sigmal
...
%sigma = 0.0005;					% Ecart-type du noyau gaussien 0.006
...
sigmadete=[sigmadete double(nb_classif_OK/nb_donnees_test*100)];
end

plot(sigmal,sigmadete,'r');
figure;